...
function Card({ profile }) {
    ...
    return (
        <div className='card bg-light'>
            ...
            <ul>
                <li className="split"><span>Name:</span> <span>{login || 'n/a'}</span></li>
                <li className="split"><span>Company:</span> <span>{company || 'n/a'}</span></li>
                <li className="split"><span>Followers:</span> <span>{followers}</span></li>
                <li className="split"><span>Following:</span> <span>{following}</span></li>
                <li className="split"><span>Repositories</span> <span>{public_repos}</span></li>
            </ul>
        </div>
    );
}
